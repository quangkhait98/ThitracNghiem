	...
	<div class="container-main">
		<div class="header">
			<div class="center-header">
				...
				<div class="contact">
					<div class="email">
						<span class="gmail"> <a href="gmail.com"><img
								src="images/icongmail.png"></a>
						</span> <span class="facebook"> <a href="facebook.com"><img
								src="images/fb.png"></a>
						</span>
					</div>
					<div class="phone">
				...
				<div class="choose-role">
					...
					<div class="custom-control custom-radio">
						<input type="radio" class="custom-control-input"
							...
							class="custom-control-label" for="defaultGroupExample1">Giảng
							viên</label>
					</div>
					...
					<div class="custom-control custom-radio">
						...
						<label class="custom-control-label" for="defaultGroupExample2">Sinh
							viên</label>
					</div>
				</div>
